...
$sql = "SELECT * FROM user WHERE role = 'penjual'";
...
<body>
  ...
  <section class="products" id="products">
    <h1 class="heading">our <span>Stands</span></h1>
    <div class="box-container">
      ...
      ?>
          <div class="box">
            ...
            <div class="image">
              <img src="./image/profile/<?php echo $row['foto'] ?>" alt="" />
            </div>
            <div class="box-bottom">
              <div class="info">
                <span class="amount">Klik menu untuk memesan</span>
              </div>
              <div class="product-btn">
                <a href="menu.php?stand=<?php echo $row['id'] ?>">
                  <i class="fas">Menu</i>
                </a>
              </div>
            </div>
