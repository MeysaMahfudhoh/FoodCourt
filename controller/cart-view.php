...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT  keranjang.id AS id_ker, keranjang.status, keranjang_detail.id_keranjang ,keranjang_detail.id, menu.nama_menu, menu.harga_menu, menu.gambar_menu , keranjang_detail.jumlah, keranjang_detail.total, keranjang_detail.id_keranjang FROM keranjang_detail 
